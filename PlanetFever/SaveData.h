...
private:
	...
	int playCounts[PlanetInfo::MaxStage];	// ステージ毎の挑戦回数
...
public:
	...
	void AddPlayCount(PlanetInfo::PlanetName stage) { playCounts[static_cast<int>(stage)]++; }
	int GetPlayCount(PlanetInfo::PlanetName stage) const { return playCounts[static_cast<int>(stage)]; }
};
